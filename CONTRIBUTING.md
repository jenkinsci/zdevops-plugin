...
This document is a living summary of conventions and best practices for development within Zowe zDevOps Plugin.

## General
The following list describes general conventions for contributing to Zowe zDevOps Plugin:
