...
open class TestJob(parent: ItemGroup<*>?, name: String?) : Job<TestJob, TestRun>(parent, name) {
    override fun isBuildable(): Boolean {
        TODO("Not yet implemented")
    }

    override fun _getRuns(): SortedMap<Int, out TestRun> {
        TODO("Not yet implemented")
    }

    override fun removeRun(run: TestRun?) {
        TODO("Not yet implemented")
    }

}

open class TestRun(job: TestJob) : Run<TestJob, TestRun>(job)
